// ── Central data file — edit this to update all content ──
...
export const experience = [
  {
    title: "Yard & Transport Manager | HSE Lead",
  ...
  {
    title: "Scaffolder | Document Controller",
    company: "SAMM Professionals",
    location: "Deer Park, VIC",
    period: "Jun 2023 – Feb 2024",
    type: "Part-time",
    bullets: [
      "Reduced overhead costs by 30% through strategic redesign of digital document storage and management workflows.",
      "Administered fully remote document control system with 24-hour turnaround and quarterly audit-ready records.",
    ],
  },
  {
    title: "HSE Officer",
    company: "Saipem Taqa Al-Rushaid (Under Saudi Aramco)",
    location: "Saudi Arabia",
    period: "Jun 2021 – Apr 2023",
    type: "Full-time",
    bullets: [
      "Developed comprehensive HSE frameworks aligned with Saudi Aramco international standards — JHAs, incident reports, environmental impact assessments.",
      "Delivered expert-led safety training for a diverse multinational workforce, achieving zero-incident outcomes on Aramco-regulated projects.",
      "Maintained audit-ready records and contributed to high-level HSE Manager and Zero Accident Team meetings.",
    ],
  },
  {
    ...
    type: "Internship",
    bullets: [
      "Built responsive UIs using HTML5, CSS3, React.js and Redux — increasing user satisfaction by 31%.",
      "Developed Node.js back-end services, boosting audience engagement by 15%.",
    ],
  },
];
